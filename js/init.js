...
function arlo_tm_modalbox_news() {
  ...
  var button = jQuery(
    ".arlo_tm_news .arlo_tm_full_link, .arlo_tm_news .news_list .title a, .arlo_tm_news .arlo_tm_button a"
  );
...
function arlo_tm_section_top() {
  "use strict";
  var button = jQuery(
    ".arlo_tm_sidebar_menu .menu ul li a,.arlo_tm_mobile_menu .menu_list ul li a"
  );
  var section = jQuery(".arlo_tm_section");
  button.on("click", function () {
...
function arlo_tm_borders() {
  "use strict";
  jQuery(".arlo_tm_mainpart").append(
